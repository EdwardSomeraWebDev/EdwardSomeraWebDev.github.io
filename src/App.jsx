...
const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      ["Kentico", "kentico", "F05A22"],
      ["ACF", "advancedcustomfields", "00E4BC"],
      ["PHP", "php", "777BB4"],
      ["MySQL", "mysql", "4479A1"],
    ],
  },
  {
    ...
    items: [
      ...
      ["WCAG", "w3c", "005A9C"],
      ["SEO", "googlesearchconsole", "458CF5"],
      ["Agile", "jira", "0052CC"],
    ],
  },
];
...
const projects = [
  {
    ...
    description:
      "Wholesale e-commerce platform for a Canadian First Nations vape and smoke distributor, with account registration, product navigation and retailer-focused purchasing flows.",
    tags: ["WordPress", "WooCommerce", "B2B", "Thrive API Integration"],
  ...
  },
  {
    ...
    description:
      "Responsive Canadian retail store for vape, smoke and nicotine products featuring category merchandising, nationwide shipping content and conversion-focused shopping experiences.",
    tags: ["WordPress", "WooCommerce", "SEO", "Thrive API Integration"],
  ...
  },
  {
    ...
    description:
      "Mobile-friendly e-commerce website for First Nations tobacco products with product bundles, brand browsing, streamlined checkout and discreet-delivery messaging.",
    tags: ["WordPress", "WooCommerce", "Thrive API Integration"],
  ...
  },
  {
    ...
    description:
      "Professional solar-energy website designed to present services clearly, build customer trust and generate qualified residential and commercial installation inquiries.",
  ...
  },
  {
    title: "Coefficients",
    description:
      "Corporate website for outsourcing, digital solutions and skills development, presenting service offerings, business capabilities and consultation pathways.",
  ...
  },
  {
    title: "Toro Vape",
    description:
      "Canadian vape retail website with location-specific shopping experiences, product discovery, subscription flows and conversion-focused WooCommerce customization.",
    tags: [
      "WordPress",
      "WooCommerce",
      "Subscriptions",
      "Thrive API Integration",
    ],
  ...
  },
  {
    title: "Sativa Bliss",
    description:
      "Multi-store cannabis e-commerce website featuring store selection, branch-specific online menus, custom product integrations and location-aware shopping flows.",
    tags: ["WordPress", "TechPOS API Integration"],
  ...
  },
  {
    title: "HaulSaver",
    description:
      "Reverse logistics marketplace connecting shippers and carriers through shipment requests, competitive offers, role-based accounts and transaction workflows.",
  ...
  return (
    <div className="site-shell">
      <header className={`site-header ${scrolled ? "scrolled" : ""}`}>
        ...
        <nav className={menuOpen ? "open" : ""}>
          {["About", "Skills", "Projects", "Experience", "Contact"].map((i) => (
            <a key={i} href={`#${i.toLowerCase()}`} onClick={close}>
              {i}
            </a>
          ))}
          <a
            className="button button-outline nav-cta"
            href={`${import.meta.env.BASE_URL}assets/Edward_Somera_CV.pdf`}
            download
          >
      ...
      <main>
        <section className="hero section" id="home">
          <div className="hero-copy">
            ...
            <p>
              ...
              e-commerce stores and web applications using modern front-end
              technologies and WordPress.
            </p>
            ...
            <div className="socials">
              <a
                href="https://github.com/EdwardSomeraWebDev"
                target="_blank"
                rel="noreferrer"
              >
                <b>GH</b>
              ...
              <a className="cube" href="#skills">
                ◇
              </a>
              <a href="mailto:edwardsomerawebdev@gmail.com">
                <Mail />
              </a>
            </div>
          </div>
          <div className="hero-visual">
            <div className="portrait-wrap">
              <img src={portrait} alt="Edward Somera" />
            </div>
        ...
        <section className="section bordered" id="about">
          <div className="about-grid">
            <div>
              ...
              <p className="muted">
                Web Developer with 12 years of experience delivering responsive
                websites, e-commerce stores, web applications and user
                interfaces for clients in Canada, the United States and
                enterprise teams. I specialize in front-end development, custom
                WordPress builds, CMS implementation, API integration, SEO,
                accessibility and performance optimization.
              </p>
              <a href="#contact" className="mini-button">
                More about me <UserRound size={14} />
              </a>
            </div>
        ...
        <section className="section bordered" id="skills">
        ...
        <section className="section bordered" id="projects">
          <div className="section-heading-row">
            ...
            <a
              className="text-link"
              href="https://edwardsomerawebdev.github.io"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="projects-grid">
            {projects.map((p) => (
              <article className="project-card" key={p.title}>
                <a
                  className={`project-image ${p.className}`}
                  href={p.url}
                  target="_blank"
                  rel="noreferrer"
                  aria-label={`Visit ${p.title}`}
                >
                  <span className="mock-site">
                    <b>{p.title}</b>
                    <em>Selected client project</em>
                    <i>Visit website</i>
                  </span>
        ...
        <section className="section bordered" id="experience">
        ...
        <section className="section contact-section bordered" id="contact">
          <div className="contact-copy">
            <SectionTitle>Let's work together!</SectionTitle>
            <p>I'm currently open to new opportunities.</p>
            <a href="mailto:edwardsomerawebdev@gmail.com">
              <Mail size={17} /> edwardsomerawebdev@gmail.com
            </a>
            <a href="tel:+639999969821">
              <Phone size={17} /> +63 999 996 9821
            </a>
            <span>
              <MapPin size={17} /> Lucena City, Philippines
            </span>
          </div>
          <form
            className="contact-form"
            action="https://formsubmit.co/edwardsomerawebdev@gmail.com"
            method="POST"
          >
      ...
      <footer>
        <span>
          © {new Date().getFullYear()} Edward Somera. All rights reserved.
        </span>
...
function Stat({ icon, value, label, compact = false }) {
  return (
